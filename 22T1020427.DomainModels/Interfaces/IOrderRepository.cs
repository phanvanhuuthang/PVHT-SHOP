...
namespace SV22T1020427.DataLayers.Interfaces
{
    /// <summary>
    ...
    public interface IOrderRepository
    {
        ...
        /// </summary>
        Task<List<OrderMonthlyRevenue>> GetMonthlyRevenueAsync(int year);

        /// <summary>
        /// Lấy danh sách sản phẩm bán chạy.
        /// </summary>
        Task<List<TopSellingProductInfo>> GetTopSellingProductsAsync(int topN);

        /// <summary>
        /// Lấy các đơn hàng đang cần xử lý.
        /// </summary>
        Task<List<OrderViewInfo>> ListProcessingOrdersAsync(int topN);
    }
}
